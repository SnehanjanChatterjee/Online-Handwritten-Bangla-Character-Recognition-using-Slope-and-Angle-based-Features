...
void main()
    {
        FILE *fp;
        FILE *ptr;
        ptr=fopen("D:\\SLOPE_ANGEL CODES\\DAT FILES\\CG_MULTIPLE_ANGLE(1).DAT(10k)","a");
        ...
        puts(r);
        fp=fopen(r,"r");
        i=0;cg_x=0.0;cg_y=0.0;sum_x=0.0;sum_y=0.0;j=0;slope1=0.0;slope2=0.0;angle1=0.0;angle2=0.0;
        while(!feof(fp))
            {
